      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="证件号码">
            <el-input v-model="form.userCertifcode" style="width: 370px;" />
          </el-form-item>
          ...
          <el-form-item label="租车时长">
            <el-input v-model="form.carRentalTime" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="租车开始时间">
            <el-date-picker v-model="form.carRentalStart" type="datetime" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="租车结束时间">
            <el-date-picker v-model="form.carRentalEnd" type="datetime" style="width: 370px;" />
          </el-form-item>
        </el-form>
