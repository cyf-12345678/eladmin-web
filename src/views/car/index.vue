  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <label class="el-form-item-label">车主姓名</label>
        <el-input v-model="query.carOwner" clearable placeholder="车主姓名" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">联系电话</label>
        <el-input v-model="query.carPhone" clearable placeholder="联系电话" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="车主姓名">
            <el-input v-model="form.carOwner" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="联系电话">
            <el-input v-model="form.carPhone" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="车牌号">
            <el-input v-model="form.carCode" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="车辆照片">
            <el-input v-model="form.carPhoto" style="width: 370px;" />
          </el-form-item>
          ...
          <el-form-item label="车身颜色">
            <el-select v-model="form.carColor" filterable placeholder="请选择">
              <el-option
                v-for="item in dict.car_color"
                :key="item.id"
                :label="item.label"
                :value="item.value"
              />
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="carPhone" label="联系电话" />
        <el-table-column prop="carCode" label="车牌号" />
        <el-table-column prop="carPhoto" label="车辆照片" />
        <el-table-column prop="carBrand" label="车辆品牌">
          <template slot-scope="scope">
            {{ dict.label.car_brand[scope.row.carBrand] }}
          </template>
        </el-table-column>
        <el-table-column prop="carColor" label="车身颜色">
          <template slot-scope="scope">
            {{ dict.label.car_color[scope.row.carColor] }}
          </template>
        </el-table-column>
...
const defaultForm = { id: null, carType: null, carOwner: null, carPhone: null, carCode: null, carPhoto: null, carBrand: null, carColor: null, createUser: null, createTime: null, updateUser: null, updateTime: null }
export default {
  name: 'CarInfo',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  dicts: ['car_type', 'car_brand', 'car_color'],
  cruds() {
  ...
  data() {
    return {
      ...
      queryTypeOptions: [
        ...
        { key: 'carOwner', display_name: '车主姓名' },
        { key: 'carPhone', display_name: '联系电话' },
